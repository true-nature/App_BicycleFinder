...
void Config_vSetDefaults(tsFlashApp *p) {
	...
	p->u8id = 124;
	p->u32Opt = (E_APPCONF_OPT_LOUDNESS_EN1 | E_APPCONF_OPT_LOUDNESS_EN2
			| E_APPCONF_OPT_DISABLE_ADC | E_APPCONF_OPT_LOW_LATENCY_INPUT);	// LOUDNESS_EN1,LOUDNESS_EN2,DISABLE_ADC,LOW_LATENCY_INPUT
#else
	p->u8id = 0;
	p->u32Opt = E_APPCONF_OPT_DISABLE_ADC;	// DISABLE_ADC
#endif
