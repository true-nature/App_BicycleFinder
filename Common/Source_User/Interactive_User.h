...
#define E_APPCONF_OPT_LOUDNESS_EN1 0x40000UL //!< PWM昇圧を有効とする(EN1:+1)
#define E_APPCONF_OPT_LOUDNESS_EN2 0x80000UL //!< PWM昇圧を有効とする(EN2:+2)
...
#define IS_APPCONF_OPT_LOUDNESS_EN1() (sAppData.sFlash.sData.u32Opt & E_APPCONF_OPT_LOUDNESS_EN1) //!< E_APPCONF_OPT_LOUDNESS_EN1判定 @ingroup FLASH
#define IS_APPCONF_OPT_LOUDNESS_EN2() (sAppData.sFlash.sData.u32Opt & E_APPCONF_OPT_LOUDNESS_EN2) //!< E_APPCONF_OPT_LOUDNESS_EN2判定 @ingroup FLASH
